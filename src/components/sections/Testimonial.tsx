  ...
  return (
    <section className="mx-auto flex w-full flex-col items-center gap-5 rounded-xl md:flex-row md:gap-10 lg:w-4/5">
      ...
      <div className="w-full text-center md:text-left">
        <p>
          "Als Mitverantwortlicher für die stetige Optimierung des Energieverbrauches an unserer
          Schule kann ich mit gutem Gewissen behaupten, dass ClassInsights die perfekte Balance
          zwischen hoher Energieeffizienz und einfacher Computerverwaltung darstellt." ~{" "}
        ...
        >
          <BriefcaseBusiness width={20} className="hidden shrink-0 md:inline" />
