...
const WPF = () => (
  <section className="flex w-full flex-col items-center justify-between gap-10 md:flex-row md:gap-20">
    ...
    <div className="pb-14 text-center md:w-3/5 md:text-left xl:pb-20">
      ...
      <p>
        Nutzer können das Herunterfahren des Computers jederzeit verhindern, um ungespeicherte
        Arbeit zu schützen. Bei Inaktivität schaltet sich das Gerät nach einstellbarer Zeit
        automatisch aus.
      </p>
    </div>
  </section>
