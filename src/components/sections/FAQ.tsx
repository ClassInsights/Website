  ...
  return (
    <section>
        ...
        {[
          ...
          [
            ...
            <p key="test">
              ...
              registrieren. Nach erfolgreicher Registrierung und Installation können Sie mit dem
              zugesendeten Lizenzschlüssel ClassInsights für 30 Tage testen.
            </p>,
          ],
          [
            "Handelt es sich um ein Abonnement?",
            <p key="subscription">
              ClassInsights sagt NEIN zu vergessenen Abonnements oder umständlichen
              Kündigungsverfahren. Sie können eine einjährige Lizenz erwerben, die automatisch
              ausläuft. Wenn kein Interesse mehr besteht, kann man einfach die Zeit auslaufen
              lassen.
            </p>,
          ],
          [
      ...
      <p>
        ...
        <a href="mailto:office@classinsights.at" className="text-primary select-auto">
