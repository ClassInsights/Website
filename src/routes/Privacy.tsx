	...
	return (
		<>
			...
			<p className="pb-2">
				...
				Verfahren ausgeführter Vorgang oder jede solche Vorgangsreihe im Zusammenhang mit personenbezogenen Daten, wie
			...
			<p className="pb-2">
				...
				Anbieter einen Cookie-Manager ein. Bei dem Aufruf der Website wird ein Cookie mit den Einstellungsinformationen
				auf dem Endgerät des Nutzers abgelegt, sodass bei einem weiteren Besuch die Abfrage in Bezug auf die
				Einwilligung nicht erfolgen muss. Das Cookie ist erforderlich um eine rechtskonforme Einwilligung des Nutzers
				einzuholen.
			</p>
			...
			<p className="pb-2">
				...
				diese Cookies Daten zur Vertragsanbahnung oder Vertragsabwicklung verarbeitet werden.
			</p>
			<p className="pb-2">
			...
			<p className="pb-2">
				...
				beantworten. Rechtsgrundlage für diese Verarbeitung ist Art. 6 Abs. 1 lit. b&#41; DSGVO.
			</p>
			<p className="pb-2">
			...
			<p className="pb-2">
				...
				dient, so ist Rechtsgrundlage für diese Verarbeitung auch noch Art. 6 Abs. 1 lit. b&#41; DSGVO.
			</p>
			<p className="pb-2">
			...
			<p className="pb-2">
				...
				müssen wir aber steuer- und handelsrechtliche Aufbewahrungsfristen beachten.
			</p>
			...
			<p className="pb-2">
				...
				ausschließlich für vorvertragliche Leistungen, für die Vertragserfüllung oder zum Zwecke der Kundenpflege (bspw.
				um Ihnen eine Übersicht über Ihre bisherigen Bestellungen bei uns zur Verfügung zu stellen) erheben und
				speichern. Gleichzeitig speichern wir dann die IP-Adresse und das Datum Ihrer Registrierung nebst Uhrzeit. Eine
			...
			<p>
				Wir erheben und speichern folgende Kundendaten: Name, Adresse, E-Mail-Adresse, Telefonnummer und
				Zahlungsinformationen. Diese Daten werden für die folgenden Zwecke verwendet:
			</p>
			<ul className="list-inside list-disc pb-3">
				{[
			...
			<p className="pb-2">
				Die Speicherung Ihrer Daten erfolgt nur so lange, wie es für die oben genannten Zwecke erforderlich ist. In der
				Regel werden Ihre Daten nach Abschluss des Vertragsverhältnisses und Ablauf der gesetzlichen
				Aufbewahrungsfristen gelöscht, es sei denn, Sie haben einer längeren Speicherung zugestimmt.
			</p>
			...
			<p className="pb-2">
				...
				Daten durch Ihren Internet-Browser an uns bzw. an unseren Webserver-Provider übermittelt. Mit diesen sog.
			...
			<p className="pb-2">Rechtsgrundlage für die Verarbeitung ist Art. 6 Abs. 1 lit. b&#41; DSGVO.</p>
			<p className="pb-2">
				Wir löschen die Daten mit vollständiger Vertragsabwicklung, müssen dabei aber die steuer- und handelsrechtlichen
				Aufbewahrungsfristen beachten.
			</p>
			<p className="pb-2">
				Im Rahmen der Vertragsabwicklung geben wir Ihre Daten an das mit der Warenlieferung beauftragte
				Transportunternehmen oder an den Finanzdienstleister weiter, soweit die Weitergabe zur Warenauslieferung oder zu
				Bezahlzwecken erforderlich ist.
			</p>
			<p className="pb-2">Rechtsgrundlage für die Weitergabe der Daten ist dann Art. 6 Abs. 1 lit. b&#41; DSGVO.</p>
			<h3 className="mt-6 pb-3">YouTube</h3>
			<p className="pb-2">
				Wir unterhalten bei YouTube eine Onlinepräsenz um unser Unternehmen sowie unsere Leistungen zu präsentieren und
				mit Kunden/Interessenten zu kommunizieren. YouTube ist ein Service der Google Ireland Limited, Gordon House,
				Barrow Street, Dublin 4, Irland, ein Tochterunternehmen der Google LLC, 1600 Amphitheatre Parkway, Mountain
				View, CA 94043 USA.
			</p>
			<p className="pb-2">
				Insofern weisen wir darauf hin, dass die Möglichkeit besteht, dass Daten der Nutzer außerhalb der Europäischen
				Union, insbesondere in den USA, verarbeitet werden. Hierdurch können gesteigerte Risiken für die Nutzer insofern
				bestehen, als dass z.B. der spätere Zugriff auf die Nutzerdaten erschwert werden kann. Auch haben wir keinen
				Zugriff auf diese Nutzerdaten. Die Zugriffsmöglichkeit liegt ausschließlich bei YouTube.
			</p>
			<p>
			...
			<p className="pb-2">
				...
				als sog. CDN (Content-Delivery-Network) ein. Es handelt sich hierbei um einen Dienst der Cloudflare Inc., 101
				Townsend Street, San Francisco, California 94107, USA, nachfolgend nur „CloudFlare“ genannt.
			</p>
			<p className="pb-2">
			...
			<p>
				...
				Hierbei werden statistische Zugriffsdaten über den Besuch unseres Internetauftritts erhoben und durch CloudFlare
				ein Cookie über Ihren Internet-Browser auf Ihrem Endgerät gespeichert. Zu den Zugriffsdaten zählen:
			</p>
			<ul className="list-inside list-disc pb-3">
				{[
					"Ihre IP-Adresse,",
			...
			<p>
				...
				<a href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noreferrer" className="text-primary">
			...
			<h3 className="mt-6 pb-3">YouTube</h3>
			<p className="pb-2">
				In unserem Internetauftritt setzen wir YouTube ein. Hierbei handelt es sich um ein Videoportal der Google
				Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, nachfolgend nur „YouTube“ genannt.
			</p>
			<p className="pb-2">
				Wir nutzen YouTube im Zusammenhang mit der Funktion „Erweiterter Datenschutzmodus“, um Ihnen Videos anzeigen zu
				können. Im Falle einer von Ihnen erteilten Einwilligung für diese Verarbeitung ist Rechtsgrundlage Art. 6 Abs. 1
				lit. a DSGVO. Rechtsgrundlage kann auch Art. 6 Abs. 1 lit. f DSGVO sein. Unser berechtigtes Interesse liegt in
				der Qualitätsverbesserung unseres Internetauftritts. Die Funktion „Erweiterter Datenschutzmodus“ bewirkt laut
			...
			<p className="pb-2">
				Ohne diesen „Erweiterten Datenschutz“ wird eine Verbindung zum Server von YouTube in den USA hergestellt, sobald
				Sie eine unserer Internetseiten, auf der ein YouTube-Video eingebettet ist, aufrufen.
			</p>
			<p className="pb-2">
				Diese Verbindung ist erforderlich, um das jeweilige Video auf unserer Internetseite über Ihren Internet-Browser
				darstellen zu können. Im Zuge dessen wird YouTube zumindest Ihre IP-Adresse, das Datum nebst Uhrzeit sowie die
				von Ihnen besuchte Internetseite erfassen und verarbeiten. Zudem wird eine Verbindung zu dem Werbenetzwerk
			...
			<p className="pb-2">
				Zum Zwecke der Funktionalität sowie zur Analyse des Nutzungsverhaltens speichert YouTube dauerhaft Cookies über
			...
			<p className="pb-2">
				Weitergehende Informationen über die Erhebung und Nutzung von Daten sowie Ihre diesbezüglichen Rechte und
			...
			<p className="pb-2">
				...
				Messenger-Dienst WhatsApp. WhatsApp ist ein Dienst der WhatsApp Ireland Limited, 4 Grand Canal Square, Grand
				Canal Harbour, Dublin 2, Irland, nachfolgend WhatsApp, eine Tochtergesellschaft von Facebook.
			</p>
			<p className="pb-2">
				Durch die Kommunikation des Nutzers mit dem Anbieter über WhatsApp erhält sowohl der Anbieter, als auch WhatsApp
				die Mobilrufnummer des Nutzers und die Information, dass der Nutzer den Anbieter kontaktiert hat.
			</p>
			<p className="pb-2">
				Die vorgenannten Daten werden von WhatsApp auch an Server von Facebook in den USA weitergeleitet und von
				WhatsApp und Facebook entsprechend der WhatsApp-Datenschutzrichtlinie verarbeitet, was auch die Verarbeitung zu
				deren eigenen Zwecken, wie der Verbesserung des WhatsApp-Dienstes, beinhaltet.
			</p>
			...
			<p className="mt-5 pb-2">
				Näheres zum Zweck und Umfang der Datenerhebung und der weiteren Verarbeitung dieser Daten durch WhatsApp und
				Facebook sowie diesbezügliche Rechte und Einstellungsmöglichkeiten zum Schutz der Privatsphäre sind in der
				Datenschutzrichtlinie von WhatsApp enthalten:{" "}
				<a
			...
			<p className="pb-2">
				Rechtsgrundlage dieser Verarbeitungen und der Übermittlung an WhatsApp ist Art. 6 Abs. 1 S. 1 b. DSGVO, soweit
				die Kontaktaufnahme eine bestehende Vertragsbeziehung betrifft oder der Anbahnung einer solchen
				Vertragsbeziehung dient. Sollte die Kontaktaufnahme nicht aufgrund der vorstehenden Zwecke erfolgen, ist
				Rechtsgrundlage Art. 6 Abs. 1 lit. f DSGVO. Das berechtigte Interesse des Anbieters besteht an der Verbesserung
				der Servicequalität.
			</p>
			<h3 className="mt-6 pb-3">Sicherheitsmaßnahmen</h3>
			<p>
				Wir haben umfassende technische und organisatorische Maßnahmen getroffen, um Ihre personenbezogenen Daten zu
				schützen. Dies umfasst die Nutzung von Verschlüsselungstechnologien wie SSL/TLS für die sichere Übertragung von
				Daten sowie Verschlüsselung für die Speicherung. Der Zugriff auf Ihre Daten ist ausschließlich autorisierten
				Mitarbeitern gestattet und streng geregelt. Darüber hinaus setzen wir Netzwerksicherheitsmaßnahmen wie Firewalls
				ein, um unsere Systeme vor Angriffen zu schützen. Unsere Sicherheitsmaßnahmen werden regelmäßig überprüft und
				angepasst, um den aktuellen Sicherheitsstandards zu entsprechen. Trotz aller Vorsichtsmaßnahmen kann keine
				Technologie absolute Sicherheit garantieren, weshalb wir auch empfehlen, dass Sie Ihre Daten durch sichere
				Passwörter und vertrauliche Handhabung selbst schützen.
			</p>
			<p className="mt-5">
				Wir behalten uns das Recht vor, diese Datenschutzerklärung bei Bedarf anzupassen, um sie an geänderte rechtliche
				Rahmenbedingungen oder an Änderungen unserer Leistungen anzupassen. Änderungen werden auf unserer Website
				veröffentlicht. Bitte überprüfen Sie regelmäßig die Datenschutzerklärung, um sich über mögliche Anpassungen zu
				informieren. Die Datenschutzerklärung ist stets auf dem aktuellen Stand und gilt ab dem Datum der
				Veröffentlichung auf unserer Website. Bei wesentlichen Änderungen, die Ihre Rechte oder unsere Verpflichtungen
				erheblich betreffen, werden wir Sie gesondert informieren.
			</p>
			<p className="mt-5">
				<a
				...
				der{" "}
				<a href="https://www.bewertung-löschen24.de" target="_blank" rel="noreferrer" className="text-primary">
