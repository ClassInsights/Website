  ...
  <div className="top-0 min-h-dvh w-full">
    <section className="flex items-center justify-between gap-20 pt-52">
      <div className="w-full md:w-3/5">
        ...
        <p className="pb-4">
          Wir automatisieren seit 2023 die Energiesteuerung von Schulcomputern - intelligent
          integriert mit dem WebUntis-Stundenplan, um Ressourcen zu schonen und das Schulbudget zu
          entlasten.
        </p>
        <p>
          Entstanden aus einer Diplomarbeit und weiterentwickelt für die universelle Anwendung
          bieten wir eine innovative Lösung und leisten einen positiven Beitrag zum Umweltschutz.
        </p>
      </div>
