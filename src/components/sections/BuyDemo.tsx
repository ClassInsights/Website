    ...
    <section className="w-full">
      ...
      <div className="flex flex-col items-center gap-5 md:flex-row md:items-start md:justify-between">
        <p className="md:w-3/5">
          Die kostenlose Demophase wird Sie definitiv überzeugen. Mit nur wenigen Klicks erhalten
          Sie Zugriff auf das gesamte ClassInsights Ökosystem. So können Sie sich selbst ein Bild
          machen.
        </p>
