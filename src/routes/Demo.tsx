  ...
  const handleSubmit = useCallback(async () => {
    ...
    if (!isDemoRequest(demoRef.current)) {
      ...
      for (const key of [
        ...
        if (
          (key === "email" && !demoRef.current[key].includes("@")) ||
          demoRef.current[key].split("@").length !== 2
        ) {
      ...
      return (
        <div className="flex min-h-dvh flex-col items-center justify-center py-24">
          ...
          <p className="mt-6 pb-8 text-center text-lg md:w-3/4">
            Ihre Anfrage wurde erfolgreich übermittelt. In Kürze erhalten Sie eine E-Mail mit einem
            Bestätigungslink. Bitte klicken Sie auf diesen Link, um den Vorgang abzuschließen.
            Sollten Sie keine E-Mail erhalten, prüfen Sie bitte Ihren Spam-Ordner oder kontaktieren
            Sie unseren{" "}
            <a
              href="mailto:office@classinsights.at?subject=ClassInsights%20Demo%20Problem"
    ...
    case "error":
      return (
        <div className="flex min-h-dvh flex-col items-center justify-center py-24">
          ...
          <p className="mt-6 pb-8 text-center text-lg md:w-3/4">
            Leider konnte Ihre Anfrage nicht übermittelt werden. Wir bitten Sie, den Vorgang zu
            einem späteren Zeitpunkt erneut zu versuchen. Sollte das Problem fortbestehen, steht
            Ihnen unser{" "}
            <a
              href="mailto:office@classinsights.at?subject=ClassInsights%20Demo%20Problem"
              className="text-primary"
            ...
            gerne zur Verfügung, um Ihnen bei der Lösung des Problems behilflich zu sein. Wir danken
      ...
      return (
        <div className="top-0 min-h-dvh w-full">
          <section className="w-full pt-52 pb-8 md:w-3/5">
            ...
            <p className="pb-4">
              Vielen Dank für Ihr Interesse und Ihr Vertrauen in ClassInsights. Mit Ihrem
              Demo-Zugang erhalten Sie einen{" "}
              <span className="text-primary">dreimonatigen, uneingeschränkten Zugriff</span> auf das
              komplette ClassInsights Ökosystem. Nach Ablauf dieser Testphase steht es Ihnen frei,
              eine reguläre Lizenz zu erwerben. Der Übergang vom Demo-Zugang zur Vollversion erfolgt
          ...
          <form className="flex w-full flex-col gap-4 lg:w-3/5">
            ...
            <div>
              ...
              <label htmlFor="terms">
                ...
                ich mein Einverständnis zur Verarbeitung meiner personenbezogenen Daten gemäß den
                Bestimmungen der{" "}
            ...
            <div className="relative mt-4 flex flex-col items-start justify-center gap-4 pb-10 xl:flex-row xl:items-center xl:justify-start xl:pb-4">
              ...
              {missingFields.length > 0 && !isSubmitting && alreadyTried && (
                <p className="text-error absolute bottom-0 xl:static">
            ...
            <Turnstile
              ...
              onError={() =>
                toast.showMessage(
                  "Bot-Überprüfung fehlgeschlagen! Versuchen Sie es später erneut.",
                  "error",
                )
              }
